class Meteo { /* On stock toutes les données météorologiques par rapport à des coordonnées, donc par rapport à une ville  */
  Coord? coord;
...
class Coord { /* Comme sur le forecast, on récupère les coordonnées d'une ville */
  double? lon;
  double? lat;
